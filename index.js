...
const questionTools = [
  ...
  "- Like post from Target Followers",
...
const main = async () => {
  try {
    ...
    choice == questionTools[7] && require("./src/targetFollowers/like.js");
    choice == questionTools[8] &&
      require("./src/targetFollowers/likeComment.js");
    choice == questionTools[9] && require("./src/feeds/likeComment.js");
    choice == questionTools[10] && require("./src/feeds/story_views.js");
    choice == questionTools[11] && require("./src/feeds/story_views.js");
    choice == questionTools[12] && require("./src/hashtags/comment.js");
    choice == questionTools[13] && require("./src/targetLocation/comment.js");
    choice == questionTools[14] && require("./src/targetFollowers/follow.js");
    choice == questionTools[15] && require("./src/targetFollowings/follow.js");
    choice == questionTools[16] && require("./src/hashtags/follow.js");
    choice == questionTools[17] && require("./src/targetLocation/follow.js");
    choice == questionTools[18] &&
      require("./src/hashtags/followLikeComment.js");
    choice == questionTools[19] &&
      require("./src/targetFollowers/followLikeComment.js");
    choice == questionTools[20] &&
      require("./src/targetFollowers/followLikeComment2.js");
    choice == questionTools[21] &&
      require("./src/targetLocation/followLikeComment.js");
    choice == questionTools[22] &&
      require("./src/targetFollowers/followLike.js");
    choice == questionTools[23] && require("./src/dm/followLikeComment.js");
    choice == questionTools[24] && require("./src/dm/followLikeComment2.js");
    choice == questionTools[25] && require("./src/accounts/cleanMedia.js");
    choice == questionTools[26] && require("./src/accounts/cleanFollowing.js");
    choice == questionTools[27] && require("./src/accounts/notFollback.js");
    choice == questionTools[28] && process.exit();
  } catch (err) {
    print(err, "err");
  }
};
...
console.log("  - Auto Like Post from Target Followers".bold);
...
console.log(
  "  this is happening from Instagram so don't complain to me bastard".bold.red
);
